...
INCLUDES= -I/usr/local/include -I./ -I./lattice -I./kernal -I./measurement -I./scheme
...
OBJS	= data_struct.o estimator.o setup.o lattice/diluted_bilayer_heisenberg.o kernal/heisenberg_model.o measurement/observables_diluted_bilayer_heisenberg.o scheme/scheme_diluted_bilayer_heisenberg.o
